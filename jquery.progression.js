            ...
            success: function(response) {
                ...
                $selectors.each(function() {
                    for (var ctr = 0; ctr < response.length; ctr++) {
                        var $counter = $(
                            '<div class="counter">'
                                + '<div class="title"><div class="content"></div></div>'
                                + '<div class="progression"><div class="content"></div></div>'
                                + '<div style="clear: both;"></div>'
                            + '</div>'
                        ).appendTo(this);

                        $('.title .content', $counter).html(response[ctr].title);
                        ...
                        $('.progression .content', $counter).html(getDurationText(targetDate, rangeBound, true));
                    }
                });
            },
